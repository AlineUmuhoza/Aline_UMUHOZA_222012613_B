...
public class admin_signUp extends JFrame {
	...
	public admin_signUp() {
		...
		lblfnmae.setBounds(10, 25, 90, 23);
		contentPane.add(lblfnmae);
		
		JLabel lbllname = new JLabel("LAST NAME :");
		lbllname.setBounds(10, 69, 90, 23);
		...
		lblMartialStatus.setBounds(348, 30, 100, 23);
		contentPane.add(lblMartialStatus);
		
		JLabel lblDateOfBirth = new JLabel("Date of Birth :");
		lblDateOfBirth.setBounds(348, 77, 100, 23);
		contentPane.add(lblDateOfBirth);
		
		dobtxt = new JTextField();
		dobtxt.setBounds(435, 73, 180, 33);
		...
		emailtext.setBounds(435, 123, 180, 33);
		...
		passwordtext.setBounds(435, 179, 182, 33);
		...
		String[] martialStatus= {"Married","Engaged", "Divorced","Single"};
		martialStatustext = new JComboBox(martialStatus);

		martialStatustext.setBounds(435, 20, 180, 33);
